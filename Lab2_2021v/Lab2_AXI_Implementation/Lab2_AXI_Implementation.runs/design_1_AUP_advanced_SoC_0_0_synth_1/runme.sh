...
HD_PWD='C:/LocalWorkspace/EE277workspace/Lab2_2021v/Lab2_AXI_Implementation/Lab2_AXI_Implementation.runs/design_1_AUP_advanced_SoC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AUP_advanced_SoC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AUP_advanced_SoC_0_0.tcl
