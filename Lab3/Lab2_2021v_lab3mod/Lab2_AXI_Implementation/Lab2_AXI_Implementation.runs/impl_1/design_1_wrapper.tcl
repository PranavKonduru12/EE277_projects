...
namespace eval ::optrace {
  variable script "C:/LocalWorkspace/EE277workspace/Lab3/Lab2_2021v_lab3mod/Lab2_AXI_Implementation/Lab2_AXI_Implementation.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/LocalWorkspace/EE277workspace/Lab3/Lab2_2021v_lab3mod/Lab2_AXI_Implementation/Lab2_AXI_Implementation.runs/synth_1/design_1_wrapper.dcp
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source C:/LocalWorkspace/EE277workspace/Lab3/Lab2_2021v_lab3mod/pins.tcl"
    source C:/LocalWorkspace/EE277workspace/Lab3/Lab2_2021v_lab3mod/pins.tcl
  } _RESULT] 
  if {$src_rc} { 
    set tool_flow [get_property -quiet TOOL_FLOW [current_project -quiet]]
    if { $tool_flow eq {SDx} } { 
      send_gid_msg -id 2 -ssname VPL_TCL -severity ERROR $_RESULT
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script C:/LocalWorkspace/EE277workspace/Lab3/Lab2_2021v_lab3mod/pins.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script C:/LocalWorkspace/EE277workspace/Lab3/Lab2_2021v_lab3mod/pins.tcl failed"
    }
    return -code error
  }
