...
HD_PWD='C:/LocalWorkspace/EE277workspace/Lab2_2021v/Lab2_AXILiteImplement2021/Lab2_AXILiteImplement2021.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Integration_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_Integration_wrapper.tcl -notrace
