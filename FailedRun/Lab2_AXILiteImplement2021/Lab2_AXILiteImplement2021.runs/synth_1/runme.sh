...
HD_PWD='C:/LocalWorkspace/EE277workspace/Lab2_2021v/Lab2_AXILiteImplement2021/Lab2_AXILiteImplement2021.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Integration_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Integration_wrapper.tcl
