...
#
# Generated by export_simulation on Sat Oct 12 19:24:01 -0700 2024
#
################################################################################
...
'-reset_run' switch to the './AXI_Integration.sh' script.

./AXI_Integration.sh -reset_run
...
./AXI_Integration.sh -noclean_files

For more information on the script, please type './AXI_Integration.sh -help'.
