...
#still testing
#set_property -dict { PACKAGE_PIN B14   IOSTANDARD LVCMOS33 } [get_ports { hdmi_out_ddc_scl_io }] #IO_L11P_T1_SRCC_34 Sch=hdmi_tx_scl
set_property -dict { PACKAGE_PIN B9   IOSTANDARD LVCMOS33 } [get_ports { hdmi_out_ddc_sda_io }] #IO_L11N_T1_SRCC_34 Sch=hdmi_tx_sda
